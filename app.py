...
# --- Updated Move Stores Section ---
st.subheader("🔄 Move Stores to Next 5-Day Bucket")
move_input = st.text_input(
    "Enter store numbers to move to next bucket (comma-separated, e.g., S11, P5):",
    key="move_stores_input"
)

if st.button("⏩ Move Stores", key="move_stores_button"):
    if not move_input.strip():
        ...
        for store in stores_to_move:
            ...
            if store_mask.any():
                ...
                # Add 5 days to the depletion estimate
